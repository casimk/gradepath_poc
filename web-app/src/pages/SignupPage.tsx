...
export function SignupPage() {
  ...
  const handleOAuthSignup = (provider: 'google' | 'github' | 'apple' | 'facebook') => {
      ...
      <div className="auth-brand-panel">
        <div className="auth-brand-content">
          ...
          <div className="auth-brand-message">
            <h1 className="auth-brand-title">Begin Your Learning Journey</h1>
            <p className="auth-brand-subtitle">
              Join thousands of students tracking their progress, achieving their goals, and unlocking their full potential with intelligent analytics.
            </p>
          </div>

          <div className="auth-brand-features">
            <div className="auth-feature">
              <svg className="auth-feature-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="auth-feature">
              ...
              <span className="auth-feature-text">Personalized Insights</span>
            </div>
            <div className="auth-feature">
              <svg className="auth-feature-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <span className="auth-feature-text">24/7 Access</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="auth-form-wrapper">
          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            ...
            <div className="auth-field-row">
              ...
              <div className="auth-field-group">
                <label htmlFor="displayName" className="auth-field-label">
            ...
            <div className="auth-password-requirements">
              <span className="auth-requirements-title">Password requirements:</span>
